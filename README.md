...
**This app is using Flask 1.1.2 and Python 3.9.2**. The screenshot doesn't get
...
You should run [this
script](https://github.com/nickjj/docker-flask-example/blob/main/run) from
...
you can [check it
out](https://github.com/nickjj/docker-flask-example/blob/main/run) and perform
